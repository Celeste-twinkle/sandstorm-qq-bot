...
const config = {
  ...
  webSearchFallbackProviders: parseList(
    process.env.WEB_SEARCH_FALLBACK_PROVIDERS || "exa,parallel,bing",
  ),
  ...
  exaMcpUrl: (process.env.EXA_MCP_URL || "https://mcp.exa.ai/mcp").trim(),
