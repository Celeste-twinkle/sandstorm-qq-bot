...
export function isTrustedDuckDuckGoPreloadUrl(value) {
    try {
...
*/
async function searchDuckDuckGoPreloadUrl(query, maxResults = 10) {
    const results = [];
    let offset = 0;
    try {
...
async function searchDuckDuckGoHtml(query, maxResults = 10) {
