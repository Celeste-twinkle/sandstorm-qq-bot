...
function buildCookieCacheKey(url) {
    return [
        url.origin,
        getProxyUrl() || '-',
...
export function looksLikeBotChallengePage(html) {
...
const subresourceClassificationCache = new Map();
function readSubresourceClassification(hostname) {
...
function writeSubresourceClassification(hostname, allowed) {
...
export async function classifyBrowserSubresourceUrl(targetUrl) {
...
export function __resetBrowserSubresourceCacheForTests() {
    subresourceClassificationCache.clear();
}
export function __getBrowserSubresourceClassificationForTests(hostname) {
...
async function createCookieCollectionPage(browser) {
...
async function readCookiesFromPage(page, url) {
...
export async function getBrowserCookieHeader(urlInput, forceRefresh = false) {
...
export async function fetchPageHtmlWithBrowser(urlInput) {
